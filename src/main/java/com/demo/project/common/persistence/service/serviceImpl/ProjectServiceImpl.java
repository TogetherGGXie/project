...
public class ProjectServiceImpl extends ServiceImpl<ProjectMapper, Project> implements ProjectService {
    ...
    @Override
    public List<HashMap<String, Object>> getProjectSelection(List<Integer> organizationIds) {
        return projectMapper.getProjectSelection(organizationIds);
    }
    ...
    @Override
    public List<HashMap<String, Object>> getProjectNames(List<Integer> projectIds, Integer userId) {
        return projectMapper.getProjectNames(projectIds, userId);
    }
